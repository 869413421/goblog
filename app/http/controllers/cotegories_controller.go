...
func (controller *CategoriesController) Show(w http.ResponseWriter, r *http.Request) {
	// 1. 获取 URL 参数
...
func (controller *CategoriesController) Store(w http.ResponseWriter, r *http.Request) {
	// 1. 初始化数据
